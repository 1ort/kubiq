...
11. Reliability hardening (typed error mapping, retry/backoff, async-first, discovery cache) — in progress (`async-first`, discovery cache, retry/backoff completed; error hardening audit, path utils+dotted keys pending)
