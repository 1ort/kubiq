...
7. Реализовать фичу в коде.
8. Полностью пройти по затронутому коду и найти все edge-кейсы.
9. Для каждого edge-case добавить отдельный тест.
10. Убедиться, что все тесты (включая новые edge-case тесты) проходят.
11. Обновить docs.
